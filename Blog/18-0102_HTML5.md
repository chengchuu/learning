...
- [HTML5 全屏浏览器兼容方案](#html5-全屏浏览器兼容方案)
  - [零、背景](#零背景)
  - [一、接口使用 (以谷歌浏览器为例)](#一接口使用-以谷歌浏览器为例)
    - [1.requestFullscreen()](#1requestfullscreen)
    - [2.exitFullscreen()](#2exitfullscreen)
    - [3.fullscreenElement](#3fullscreenelement)
    - [4.fullscreenEnabled](#4fullscreenenabled)
  - [二、浏览器兼容](#二浏览器兼容)
