...
- [Git 版本控制：构建高效协作和开发流程的最佳实践](#git-版本控制构建高效协作和开发流程的最佳实践)
  - [前言](#前言)
  - [1. 分支命名策略](#1-分支命名策略)
    - [主要分支命名](#主要分支命名)
    - [功能性分支命名](#功能性分支命名)
...
本博客所有的原创文章，作者皆保留版权。转载必须包含本声明，保持本文完整，并以超链接形式注明作者[除除](https://github.com/mazeyqian)和本文原始地址：<https://blog.mazey.net/4581.html>
